# gatsby-starter-I Want AI

Gatsby.js V2 starter template based on I Want AI by HTML5 UP

For an overview of the project structure please refer to the [Gatsby documentation - Building with Components](https://www.gatsbyjs.org/docs/building-with-components/).

![Screenshot](./src/assets/img/I Want AI.jpg)

Check online demo [here](https://anubhavsrivastava.github.io/gatsby-starter-I Want AI/)
...
```sh
gatsby new <site-name> https://github.com/anubhavsrivastava/gatsby-starter-I Want AI
```
